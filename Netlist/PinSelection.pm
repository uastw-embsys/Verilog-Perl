...
sub new {
    ...
    my $pinselection = bless({}, $class);
    $pinselection->{_netname} = $netname;
    $pinselection->{_msb} = $msb;
    $pinselection->{_lsb} = $lsb;
    return $pinselection;
}
...
sub netname {
    my ($self, $new) = @_;
    $self->{_netname} = $new if (@_ == 2);
    return $self->{_netname};
}

sub lsb {
    my ($self, $new) = @_;
    $self->{_lsb} = $new if (@_ == 2);
    return $self->{_lsb};
}

sub msb {
    my ($self, $new) = @_;
    $self->{_msb} = $new if (@_ == 2);
    return $self->{_msb};
}
